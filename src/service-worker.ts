...
const CACHE_NAME = "hn-newstories";
...
// Intercept any network requests and check if data is available in the cache first
  ...
  event.respondWith(
    caches.open(CACHE_NAME).then((cache) =>
      cache.match(event.request).then(function (response) {
        ...
        console.log("Not found in cache. Calling API..");
